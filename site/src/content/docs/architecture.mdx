...
<Verdict state="designed" /> this page is the design contract for v2 — schemas and hook
behavior are final, but the state layer, hooks, and agents land with their
epics (see the [roadmap](https://github.com/jjanczur/tyran#roadmap)). Today the repo ships the
