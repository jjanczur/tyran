...
description: 'Install Tyran, run setup, and drive a first initiative. What works today, what is labelled as coming, and how to stop a run from anywhere.'
---
import { Aside, Steps, Tabs, TabItem } from '@astrojs/starlight/components';
import Verdict from '../../components/Verdict.astro';

<Aside type="note" title="Status">
Tyran v2 is under active construction. This page documents what
...
<Verdict state="shipped" label="works today" />
