---
title: 'FAQ'
description: 'Short answers on trusting an agent with commits, choosing models, stopping a run, what a plugin update does to local learning, and the name.'
---
...
`/tyran:setup` — see the [roadmap](https://github.com/jjanczur/tyran#roadmap), which is honest and
test-gated.
...
pro-workflow?**
See the [comparison table](https://github.com/jjanczur/tyran#how-it-compares) — every cell is
