---
title: 'The roster, and how models are chosen'
description: 'The four shipped agents, how role names resolve to models and reasoning effort, the floors an override cannot cross, and the .tyran/STOP brake.'
---
...
<Aside type="danger" title="The floor an override cannot cross">
...
<Limit title="The brake stops misbehaviour, not evasion">
