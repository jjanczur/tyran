...
|---|---|---|
| **AUTO** | knowledge facts, rule tweaks, `.tyran/config.yaml`, agent overrides (since 0.1.44), new repo-specific skills (must pass an activation test) | retro commits autonomously; ledger entry; `git revert` rolls back |
