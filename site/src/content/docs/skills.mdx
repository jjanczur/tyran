---
title: 'What Tyran ships: fourteen skills and four agents'
description: 'The fourteen skills and four agents the plugin installs, each with its role, the assumption it rests on, and whether a person or the conductor normally invokes it.'
---
