---
title: 'Videos'
description: 'Five cuts explaining Tyran — the explainer, the first-session tutorial, and three shorts on the mistake, the board and the retrospective. What each one answers and when to send it.'
---
...
{/* youtube-nocookie, not youtube.com: the docs site sets no cookie of its own
    and an embed that does would make that untrue on this one page. Every ID
    also lives in src/data/videos.json, which is where a moved link is fixed. */}
...
board in all of them is the one you can [click yourself](../sandbox/) — no
install.
...
<div style="margin:1.5rem 0"><iframe src="https://www.youtube-nocookie.com/embed/ThulYtbYNXI" title="Tyran" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;aspect-ratio:16/9;border:0;border-radius:6px"></iframe></div>
...
<div style="margin:1.5rem 0"><iframe src="https://www.youtube-nocookie.com/embed/vr49hKk9G8g" title="Tyran" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;aspect-ratio:16/9;border:0;border-radius:6px"></iframe></div>
...
**Use it for:** the [getting started](../getting-started/) page, onboarding a
...
<div style="max-width:320px;margin:1.5rem 0"><iframe src="https://www.youtube-nocookie.com/embed/2EgRBR0fVRo" title="Tyran" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;max-width:320px;aspect-ratio:9/16;border:0;border-radius:6px"></iframe></div>
...
<div style="max-width:320px;margin:1.5rem 0"><iframe src="https://www.youtube-nocookie.com/embed/HKePDLkYDqA" title="Tyran" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;max-width:320px;aspect-ratio:9/16;border:0;border-radius:6px"></iframe></div>
...
[sandbox](../sandbox/) so they can click it themselves.

## It learns you

**1:22 · 9:16 · the differentiator.**

<div style="max-width:320px;margin:1.5rem 0"><iframe src="https://www.youtube-nocookie.com/embed/EMcPJj7c0mk" title="Tyran" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;max-width:320px;aspect-ratio:9/16;border:0;border-radius:6px"></iframe></div>
...
**Use it for:** the [self-improvement](../self-improvement/) page, and the reply
