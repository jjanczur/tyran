...
([self-improvement](../self-improvement/) holds the thresholds). Seeding is create-only, so a repo
...
does not mention the block. [`configuration.md`](../configuration/#boundaries--giving-agents-more-room)
