...
description: 'Install Tyran, run setup, and drive a first initiative: the commands that work today, and how to stop a run from anywhere.'
---
import { Steps, Tabs, TabItem } from '@astrojs/starlight/components';
import Provenance from '../../components/Provenance.astro';

<Provenance state="shipped">
every command on this page works today
</Provenance>
