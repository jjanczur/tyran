...
[roadmap](architecture.md#roadmap), which is honest and test-gated.
...
[the journal's guarantees](journal.md#guarantees). ⁹ The retrospective is
...
What each skill is for is in [skills and agents](skills.md), one directory
each.
